...
dt = 0.01; % time step for display and linear models
...
[yH, yO, yB] = energyConsumptionODE(p_O2_nonlin, p_H2_nonlin, dt,consumption_time,params); % simulate energy consumption side

%% Linear Model
[ t_lin, y_lin, moles_H2_lin, moles_O2_lin, p_H2_lin, p_O2_lin ] = simulate_generation_linear(generation_time,params);
[yH, yO, yB] = energyConsumption(p_O2_lin, p_H2_lin, dt, consumption_time,params);
